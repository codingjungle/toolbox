...
use Composer\Autoload\ComposerStaticInitbcc7c6cbd9cf60c1182d9873f7e0285f;
...
class ComposerAutoloaderInitbcc7c6cbd9cf60c1182d9873f7e0285f
{
    ...
    public static function getLoader()
    {
        ...
        spl_autoload_register(array('ComposerAutoloaderInitbcc7c6cbd9cf60c1182d9873f7e0285f', 'loadClassLoader'), true,
            true);
        ...
        if ($useStaticLoader) {
            ...
            call_user_func(ComposerStaticInitbcc7c6cbd9cf60c1182d9873f7e0285f::getInitializer($loader));
        } else {
