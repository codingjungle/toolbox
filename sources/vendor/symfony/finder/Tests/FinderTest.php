...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testDate()
    {
        ...
        $this->assertIterator($this->toAbsolute(['foo/bar.tmp', 'test.php']),
            $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    {
        $finder = $this->buildFinder();
        $this->assertSame($finder,
            $finder->filter(function (SplFileInfo $f) { return false !== strpos($f, 'test'); }));
        $this->assertIterator($this->toAbsolute(['test.php', 'test.py']), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testGetIterator()
    {
        ...
        $finder = $this->buildFinder();
        $this->assertEquals(3, iterator_count($finder->directories()->in(self::$tmpDir)),
