...
abstract class IteratorTestCase extends TestCase
{
    ...
    {
        $values = array_map(function (SplFileInfo $fileinfo) { return $fileinfo->getPathname(); },
    ...
    {
        $values = array_values(array_map(function (SplFileInfo $fileinfo) { return $fileinfo->getPathname(); },
            iterator_to_array($iterator)));
