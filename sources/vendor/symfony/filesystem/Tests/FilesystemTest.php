...
class FilesystemTest extends FilesystemTestCase
{
    ...
    public function testReadLinkCanonicalizePath()
    {
        ...
        $this->assertEquals($file,
            $this->filesystem->readlink($this->normalize($this->workspace . '/dir/../file'), true));
    }
    ...
    {
        $this->assertSame('../../../',
            $this->filesystem->makePathRelative('/var/lib/symfony/', 'var/lib/symfony/src/Symfony/Component'));
    }
