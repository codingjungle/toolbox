                ...
                switch ($token) {
                    ...
                    case T_DOC_COMMENT:
                        if ($beforeNamespace === true) {
                            ...
                            if ($beforeNamespace === false && $beforeClass === true) {
                            ...
                            for ($ii = $i; $ii < $count; $ii++) {
                                ...
                                if ($token2 === T_STRING) {
                                    if ($class === true) {
                                        ...
                                        if ($extends === true && $implements === false) {
                                            $extendsClass[] = $value2;
                                        } else {
                                            if ($implements === true) {
                                                Log::log($value2);
                    ...
                    case T_FUNCTION:
                        ...
                        for ($ii = $i; $ii < $count; $ii++) {
                            ...
                            if (in_array($token2, $breakOn, true)) {
                                if (in_array($tokens[$ii + 1][0], $breakOn, true) || in_array($tokens[$ii + 2][0],
                                        $breakOn, true)) {
                                    break;
                                }
                            }
...
EOF;
                ...
                if ($property['visibility'] === T_PRIVATE) {
                    ...
                    if ($property['visibility'] === T_PROTECTED) {
                        $prop .= ' protected ';
                    } else {
                        $prop .= ' public';
                    }
...
EOF;
                ...
                if ($method['visibility'] === T_PRIVATE) {
                    ...
                    if ($method['visibility'] === T_PROTECTED) {
                        $meth .= ' protected ';
                    } else {
                        $meth .= ' public';
                    }
