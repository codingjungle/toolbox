...
use IPS\toolbox\Elephant\Exception\UnsupportedActionException;
use IPS\toolbox\Elephant\Logger\LoggerAwareTrait;
use IPS\toolbox\Elephant\Payload\Decoder;
use IPS\toolbox\Elephant\StreamInterface;
use RuntimeException;

abstract class _AbstractSocketIO implements EngineInterface
{
